  ...
  return {
    ...
    panels: [
      ...
      },
      {
        ...
        lines: loading
          ? [
              "lib/app/src/tui owns terminal workflow UX and product-shell composition.",
              ...
              "lib/app/src/agent/tui stays in place as the legacy retained session monitor during migration.",
            ]
          : [
