---
name: App roadmap
description: "Future auth and workflow-web direction for @io/app."
...
- keep app-owned browser and Worker composition in `@io/app`, while leaving
  shared browser primitives in `@io/web`
