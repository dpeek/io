...
The `io` binary now comes from `@op/cli` and dispatches `io <cmd> ...` to
`./lib/cli/src/task/<cmd>.ts`, calling
...
`io tui` boots the new terminal workflow product shell from `lib/cli/src/tui/*`.
...
- [cli/index.ts](../../lib/cli/src/cli/index.ts): top-level task dispatch
- [task/agent.ts](../../lib/cli/src/task/agent.ts) and
  [agent/server.ts](../../lib/cli/src/agent/server.ts): `io agent ...`
- [task/browser-agent.ts](../../lib/cli/src/task/browser-agent.ts) and
  [browser-agent/server.ts](../../lib/cli/src/browser-agent/server.ts): `io browser-agent`
- [task/mcp.ts](../../lib/cli/src/task/mcp.ts) and
  [mcp/index.ts](../../lib/cli/src/mcp/index.ts): `io mcp ...`
