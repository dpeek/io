...
This document turns [`05-blob-ingestion-and-media.md`](./05-blob-ingestion-and-media.md)
into the canonical implementation contract for the blob tier, asynchronous
ingestion pipeline, and first file, image, and document module families.
